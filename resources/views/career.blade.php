  ...
  <div class="carrier-page py-5">
      ...
      <div class="col-md-4">
        <div class="stat-tile text-center card-lift">
          <div class="feature-icon rope mx-auto mb-3" style="width:56px;height:56px;margin:0 auto 1rem;">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="24" height="24"><rect x="3" y="3" width="8" height="8" rx="1.5"/><rect x="13" y="3" width="8" height="5" rx="1.5"/><rect x="13" y="11" width="8" height="10" rx="1.5"/><rect x="3" y="14" width="8" height="7" rx="1.5"/></svg>
          </div>
      ...
      <div class="col-md-4">
        <div class="stat-tile text-center card-lift">
          <div class="feature-icon moss mx-auto mb-3" style="width:56px;height:56px;margin:0 auto 1rem;">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="24" height="24"><circle cx="12" cy="8" r="3.2"/><path d="M5 21c0-4 3-6.5 7-6.5s7 2.5 7 6.5"/></svg>
          </div>
    ...
    <div class="row gy-3 mb-5">
      <div class="col-md-6">
        <div class="grid-card">
          ...
          <p class="text-soft mb-2" style="font-size:0.9rem;">Build and maintain the core platform, APIs, and analytics engine.</p>
          ...
          <button class="btn btn-sm btn-rope mt-3" data-bs-toggle="modal" data-bs-target="#applyModal">Apply Now</button>
        </div>
      </div>
      <div class="col-md-6">
        <div class="grid-card">
          ...
          <p class="text-soft mb-2" style="font-size:0.9rem;">Create beautiful, responsive user interfaces and interactive dashboards.</p>
          <ul class="list-unstyled" style="font-size:0.85rem;">
      ...
      <div class="col-md-6">
        <div class="grid-card">
          ...
          <p class="text-soft mb-2" style="font-size:0.9rem;">Manage infrastructure, CI/CD pipelines, and ensure 99.99% uptime.</p>
          <ul class="list-unstyled" style="font-size:0.85rem;">
      ...
      <div class="col-md-6">
        <div class="grid-card">
          ...
          <p class="text-soft mb-2" style="font-size:0.9rem;">Engage with the Knot community, manage feedback, and organize events.</p>
          <ul class="list-unstyled" style="font-size:0.85rem;">
    ...
    <form id="carrierForm" class="carrier-form" onsubmit="return false;">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" id="coverLetter" rows="4" placeholder="Tell us why you'd be a great fit for the Knot team..." required></textarea>
      </div>
      ...
      <div class="mb-4">
        ...
        <div class="upload-zone" id="uploadZone" onclick="document.getElementById('resumeInput').click()">
          ...
          <p class="mb-0">Drag and drop your resume here or <span class="text-rope fw-semibold">click to browse</span></p>
      ...
      <div class="mb-4">
        <div class="form-check">
          ...
          <label class="form-check-label" for="agreeTerms">I agree to the <a href="terms-conditions.html" class="text-rope">Terms &amp; Conditions</a> and <a href="privacy-policy.html" class="text-rope">Privacy Policy</a> <span class="text-required">*</span></label>
        </div>
      </div>
      ...
      <div class="mb-4">
        <div class="form-check">
          ...
          <label class="form-check-label" for="agreeRemote">I understand this is a remote position and I am eligible to work in the selected timezone</label>
        </div>
      </div>
    ...
    <div class="success-message d-none" id="successMessage">
      <svg viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" width="60" height="60">
        ...
        <path d="M18 30l8 8 14-14" stroke="var(--moss)" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
      <h3>Application Submitted!</h3>
      <p>Thank you for your interest in joining Knot. We'll review your application and get back to you within 5 business days.</p>
      <p class="text-faint" style="font-size:0.85rem;">Check your email at <span id="successEmail"></span> for confirmation.</p>
    </div>
  </div>
</main>
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="border-radius:var(--radius-lg);">
      ...
      <div class="modal-body">
        <p class="text-soft mb-3">You'll be redirected to the application form below. Fill out all required fields and upload your resume to apply.</p>
        <div class="data-processor">
          <h5>What to expect</h5>
          <p style="font-size:0.88rem;">After submitting, you'll receive a confirmation email. Our team will review your application and contact you for an interview within 5 business days.</p>
        </div>
      </div>
