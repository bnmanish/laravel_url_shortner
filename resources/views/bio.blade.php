            ...
            <div class="col-lg-8">
                <div class="stat-tile p-0">
                    <div class="d-flex justify-content-between align-items-center p-3 border-bottom"
                        ...
                        <button class="btn btn-sm btn-rope" data-bs-toggle="modal" data-bs-target="#createBioModal">+
                            New</button>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="pe-3 text-end">
                                        <button class="btn btn-sm btn-outline-ink"
                                            data-copy-text="https://knot.to/fernwayshop">Copy</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="ps-3">
                                    ...
                                    <td class="pe-3 text-end">
                                        <button class="btn btn-sm btn-outline-ink"
                                            data-copy-text="https://knot.to/fernwayco">Copy</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="ps-3">
                                    ...
                                    <td class="pe-3 text-end">
                                        <button class="btn btn-sm btn-outline-ink"
                                            data-copy-text="https://knot.to/fernwayblog">Copy</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="mockframe" style="width:240px;">
                            ...
                            <div class="p-3 text-center">
                                <div class="rounded-circle mx-auto mb-2"
                                    style="width:56px;height:56px;background:var(--moss-tint);"></div>
                                ...
                                <div class="d-grid gap-2 mt-3">
                                    <div class="border rounded py-2"
                                        style="border-color:var(--line)!important; font-size:0.82rem;">New arrivals</div>
                                    <div class="border rounded py-2"
                                        style="border-color:var(--line)!important; font-size:0.82rem;">Book a fitting</div>
                                    <div class="border rounded py-2"
                                        style="border-color:var(--line)!important; font-size:0.82rem;">Our story</div>
                                    <div class="border rounded py-2"
                                        style="border-color:var(--line)!important; font-size:0.82rem;">Contact us</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <form onsubmit="return false;">
                <div class="row gy-3">
                    ...
                    <div class="col-12">
                        ...
                        <button class="btn btn-sm btn-outline-ink" type="button" onclick="addBioLink()">+ Add
                            link</button>
                    </div>
                    <div class="col-12">
                        ...
                        <div class="d-flex gap-2">
                            <div class="rounded-circle"
                                style="width:32px;height:32px;background:var(--rope);border:2px solid var(--ink);"></div>
                            <div class="rounded-circle"
                                style="width:32px;height:32px;background:var(--moss);border:2px solid var(--ink);"></div>
                            <div class="rounded-circle"
                                style="width:32px;height:32px;background:var(--ink);border:2px solid var(--ink);"></div>
                            <div class="rounded-circle"
                                style="width:32px;height:32px;background:var(--line-dark);border:2px solid var(--ink);">
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
...
@push('scripts')
    <script>
        function addBioLink() {
            ...
            div.innerHTML =
                '<input type="text" class="form-control" placeholder="Link title"><input type="url" class="form-control" placeholder="https://..."><button class="btn btn-outline-ink btn-sm" type="button" onclick="this.closest(\'.input-group\').remove()">Remove</button>';
