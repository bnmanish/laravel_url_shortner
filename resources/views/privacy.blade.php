...
@section('content')
    ...
    <div class="legal-page py-5">
        ...
        <p>At Knot, we take your privacy seriously. This Privacy Policy explains how we collect, use, store, and protect
            your information when you use our link management service. By using Knot, you agree to the practices described
            in this policy.</p>
        ...
        <ul>
            <li><strong>To provide and maintain our service</strong> — including link shortening, redirection, and analytics
            </li>
            <li><strong>To process your account</strong> — registration, authentication, and profile management</li>
            <li><strong>To deliver analytics</strong> — showing you click data, geographic breakdowns, and performance
                metrics</li>
            <li><strong>To communicate with you</strong> — sending account notifications, security alerts, and service
                updates</li>
            <li><strong>To improve our service</strong> — analyzing usage patterns to develop new features and enhance
                performance</li>
            <li><strong>To ensure security</strong> — detecting and preventing fraud, abuse, and unauthorized access</li>
            <li><strong>To comply with legal obligations</strong> — responding to lawful requests and enforcing our terms
            </li>
        </ul>
        ...
        <p>We may disclose your information if required by law, court order, or government regulation, or to protect the
            rights, property, or safety of Knot, our users, or others.</p>

        <h4>3.3 Business Transfers</h4>
        <p>In the event of a merger, acquisition, or asset sale, your personal data may be transferred as part of the
            transaction. You will be notified via email or prominent notice on our website before such a transfer occurs.
        </p>
        ...
        <p>We retain your personal information for as long as necessary to fulfill the purposes outlined in this Privacy
            Policy, including for compliance with legal obligations, dispute resolution, and enforcement of our agreements.
        </p>
        <p>Link analytics data is retained for the duration of your account activity. When you delete your account, your
            personal data is removed from our active systems within 30 days, though anonymized aggregate data may be
            retained.</p>
        ...
        <ul>
            ...
            <li><strong>Objection</strong> — You can object to processing of your data, particularly for direct marketing
            </li>
            <li><strong>Withdrawal of Consent</strong> — You can withdraw consent at any time without affecting the
                lawfulness of prior processing</li>
        </ul>
        <p>To exercise any of these rights, please contact us at <a href="mailto:privacy@knot.to"
                class="text-rope">privacy@knot.to</a>.</p>

        <div class="divider my-4"></div>

        <h3>6. Security</h3>
        <p>We implement appropriate technical and organizational security measures to protect your personal data against
        ...
        <p>Please note that no method of transmission over the internet or electronic storage is 100% secure. While we
            strive to use commercially acceptable means to protect your data, we cannot guarantee absolute security.</p>

        <div class="divider my-4"></div>

        <h3>7. Cookies &amp; Tracking Technologies</h3>
        <p>We use cookies and similar tracking technologies to operate our service, improve performance, and personalize
            your experience. You can manage or disable cookies through your browser settings.</p>
        <p>By continuing to use our service, you consent to our use of cookies as described in this policy.</p>

        <div class="divider my-4"></div>

        <h3>8. Children's Privacy</h3>
        <p>Our service is not intended for individuals under the age of 16. We do not knowingly collect personal information
            from children under 16. If we become aware that we have collected such information, we will take steps to delete
            it immediately. If you are a parent or guardian and believe your child has provided us with personal data,
            please contact us at <a href="mailto:privacy@knot.to" class="text-rope">privacy@knot.to</a>.</p>

        <div class="divider my-4"></div>

        <h3>9. Changes to This Privacy Policy</h3>
        <p>We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new policy
            on this page and updating the "Last updated" date. You are encouraged to review this policy periodically.</p>
