    ...
    <header class="container py-5">
        <div class="row">
            <div class="col-lg-7">
                ...
                <p class="lede">Shortening is the easy part. Knot handles the branding, the routing, and the reporting that
                    come after someone actually clicks.</p>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="row feature-row align-items-center gy-4">
                <div class="col-lg-5">
                    ...
                    <p class="text-soft mb-3">Replace a random string with a slug that means something: <span
                            class="mono">/summer-sale</span> instead of <span class="mono">/x9k2p</span>. Add UTM
                        parameters automatically so every link arrives pre-tagged for your analytics.</p>
                ...
                <div class="col-lg-7">
                    <div class="mockframe">
                        <div class="mockframe-bar"><span class="mockframe-dot"></span><span
                                class="mockframe-dot"></span><span class="mockframe-dot"></span><span
                                class="mockframe-url">new link</span></div>
                        <div class="p-4">
                            <label class="form-label">Destination URL</label>
                            <input class="form-control mb-3" value="https://northwind.com/products/summer-sale-2026"
                                readonly>
            ...
            <div class="row feature-row align-items-center gy-4 flex-lg-row-reverse">
                <div class="col-lg-5">
                    ...
                    <p class="text-soft mb-3">Point any domain or subdomain you own at Knot and every short link inherits it
                        automatically. SSL is issued and renewed for you.</p>
                    <ul class="list-unstyled text-soft d-grid gap-2">
                ...
                <div class="col-lg-7">
                    <div class="mockframe">
                        <div class="mockframe-bar"><span class="mockframe-dot"></span><span
                                class="mockframe-dot"></span><span class="mockframe-dot"></span><span
                                class="mockframe-url">domains</span></div>
                        <div class="p-4">
                            <div class="d-flex justify-content-between align-items-center py-2 border-bottom"
                                style="border-color:var(--line)!important;"><span
                                    class="mono">go.northwind.com</span><span class="badge-tag">verified</span></div>
                            <div class="d-flex justify-content-between align-items-center py-2"><span
                                    class="mono">links.harborlight.io</span><span class="badge-tag">verified</span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row feature-row align-items-center gy-4">
                <div class="col-lg-5">
                    ...
                    <p class="text-soft mb-3">Every click records location, device, referrer, and timestamp. Filter by date
                        range or channel and export the raw data whenever you need it.</p>
                    <ul class="list-unstyled text-soft d-grid gap-2">
                ...
                <div class="col-lg-7">
                    <div class="mockframe">
                        <div class="mockframe-bar"><span class="mockframe-dot"></span><span
                                class="mockframe-dot"></span><span class="mockframe-dot"></span><span
                                class="mockframe-url">clicks &middot; last 7 days</span></div>
                        <div class="p-4">
                            <div class="bar-chart mb-2">
                                ...
                                <div class="bar is-peak" style="height:95%"></div>
            ...
            <div class="row feature-row align-items-center gy-4 flex-lg-row-reverse">
                <div class="col-lg-5">
                    ...
                    <p class="text-soft mb-3">Every short link comes with a generated QR code, styled with your brand color,
                        ready for packaging, posters, or a storefront window.</p>
                    <ul class="list-unstyled text-soft d-grid gap-2">
            ...
            <div class="row feature-row align-items-center gy-4">
                <div class="col-lg-5">
                    ...
                    <p class="text-soft mb-3">Invite your team into shared folders of links, assign roles, and keep a full
                        audit trail of who created or edited what.</p>
                    <ul class="list-unstyled text-soft d-grid gap-2">
                ...
                <div class="col-lg-7">
                    <div class="mockframe">
                        <div class="mockframe-bar"><span class="mockframe-dot"></span><span
                                class="mockframe-dot"></span><span class="mockframe-dot"></span><span
                                class="mockframe-url">team</span></div>
                        <div class="p-4">
                            <div class="d-flex justify-content-between align-items-center py-2 border-bottom"
                                style="border-color:var(--line)!important;"><span>Priya Menon</span><span
                                    class="badge-tag">admin</span></div>
                            <div class="d-flex justify-content-between align-items-center py-2 border-bottom"
                                style="border-color:var(--line)!important;"><span>Sam Whitaker</span><span
                                    class="badge-tag">editor</span></div>
                            <div class="d-flex justify-content-between align-items-center py-2"><span>Alex
                                    Duarte</span><span class="badge-tag">viewer</span></div>
                        </div>
                    </div>
                </div>
            </div>
