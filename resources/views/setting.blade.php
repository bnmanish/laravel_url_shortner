                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge-tag"
                                    style="background:var(--rope-tint); color:var(--rope-dark);">pending</span></td>
        ...
        <div class="stat-tile" style="border-color:var(--rope-dark);">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    ...
                    <p class="text-faint mb-0" style="font-size:0.82rem;">Permanently delete your workspace and all
                        associated data.</p>
                </div>
                <button class="btn btn-sm btn-outline-ink"
                    style="color:var(--rope-dark); border-color:var(--rope-dark);">Delete workspace</button>
            </div>
        </div>
