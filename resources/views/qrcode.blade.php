        ...
        <div class="row gy-3 mb-4">
            ...
            <div class="col-lg-4">
                <div class="stat-tile h-100">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-2">
                            <div class="rounded-circle"
                                style="width:28px;height:28px;background:var(--ink);border:2px solid var(--rope);"
                                title="Ink"></div>
                            <div class="rounded-circle"
                                style="width:28px;height:28px;background:var(--rope);border:2px solid var(--rope);"
                                title="Rope"></div>
                            <div class="rounded-circle"
                                style="width:28px;height:28px;background:var(--moss);border:2px solid var(--rope);"
                                title="Moss"></div>
                            <div class="rounded-circle"
                                style="width:28px;height:28px;background:var(--line-dark);border:2px solid var(--rope);"
                                title="Dark"></div>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <button class="btn btn-rope w-100" data-bs-toggle="modal" data-bs-target="#createQrModal">Generate
                        QR</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content" style="border-radius:var(--radius-md);">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-2">
                            <div class="rounded-circle"
                                style="width:32px;height:32px;background:var(--ink);border:2px solid var(--rope);"></div>
                            <div class="rounded-circle"
                                style="width:32px;height:32px;background:var(--rope);border:2px solid var(--rope);"></div>
                            <div class="rounded-circle"
                                style="width:32px;height:32px;background:var(--moss);border:2px solid var(--rope);"></div>
                            <div class="rounded-circle"
                                style="width:32px;height:32px;background:var(--line-dark);border:2px solid var(--rope);">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
