                ...
                <div class="auth-form-wrap">
                    ...
                    <form onsubmit="return false;">
                        ...
                        <div class="form-check mb-4">
                            ...
                            <label class="form-check-label text-soft" for="terms">I agree to the <a href="#"
                                    class="text-rope">Terms</a> and <a href="#" class="text-rope">Privacy
                                    Policy</a></label>
                        </div>
                    ...
                    <p class="text-center text-soft mt-4 mb-0">Already have an account? <a href="{{ route('login') }}"
                            class="text-rope fw-semibold">Log in</a></p>
                </div>
            </div>
        </div>
