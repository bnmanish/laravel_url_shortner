          ...
          <table class="table table-links mb-0">
            ...
            <tbody>
              <tr>
                ...
                <td><span class="badge-tag" style="background:var(--rope); color:white; width:fit-content;">admin</span></td>
              ...
              <tr>
                <td class="ps-3">
                  <div class="d-flex align-items-center gap-2">
                    <div class="rounded-circle" style="width:32px;height:32px;background:var(--moss);flex-shrink:0;"></div>
                    <div>
                ...
                <td><span class="badge-tag" style="background:var(--moss-tint); color:var(--moss); width:fit-content;">editor</span></td>
              ...
              <tr>
                <td class="ps-3">
                  <div class="d-flex align-items-center gap-2">
                    <div class="rounded-circle" style="width:32px;height:32px;background:var(--line-dark);flex-shrink:0;"></div>
                    <div>
                ...
                <td><span class="badge-tag" style="background:var(--paper-dim); color:var(--ink-faint); width:fit-content;">viewer</span></td>
        ...
        <div class="col-lg-8">
          <div class="stat-tile">
            ...
            <div class="d-grid gap-3">
              <div class="d-flex gap-3 align-items-start py-2 border-bottom" style="border-color:var(--line)!important;">
                ...
                <div>
                  ...
                  <div class="text-faint" style="font-size:0.78rem;">knot.to/fall-preview &middot; 2 hours ago</div>
                </div>
              </div>
              <div class="d-flex gap-3 align-items-start py-2 border-bottom" style="border-color:var(--line)!important;">
                ...
                <div>
                  ...
                  <div class="text-faint" style="font-size:0.78rem;">knot.to/spring-launch &middot; 5 hours ago</div>
                </div>
              </div>
              <div class="d-flex gap-3 align-items-start py-2 border-bottom" style="border-color:var(--line)!important;">
              ...
              <div class="d-flex gap-3 align-items-start py-2 border-bottom" style="border-color:var(--line)!important;">
                ...
                <div>
                  ...
                  <div class="text-faint" style="font-size:0.78rem;">knot.to/store-flyer &middot; 2 days ago</div>
                </div>
              </div>
          ...
          <div class="stat-tile h-100">
            ...
            <div class="d-grid gap-3">
              <div class="p-3 border rounded" style="border-color:var(--line);">
                ...
                <p class="text-faint mb-0" style="font-size:0.82rem;">Full access: create, edit, delete, invite, and manage billing.</p>
              </div>
              <div class="p-3 border rounded" style="border-color:var(--line);">
                <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <p class="text-faint mb-0" style="font-size:0.82rem;">Create and edit links, view analytics, but no billing access.</p>
              </div>
              <div class="p-3 border rounded" style="border-color:var(--line);">
                <div class="d-flex justify-content-between align-items-center mb-2">
                  <span class="fw-semibold" style="font-size:0.88rem;">Viewer</span>
                  <span class="badge-tag" style="background:var(--paper-dim); color:var(--ink-faint);">1</span>
                </div>
                <p class="text-faint mb-0" style="font-size:0.82rem;">View links and analytics only. No edit or invite permissions.</p>
              </div>
            </div>
          </div>
        </div>
